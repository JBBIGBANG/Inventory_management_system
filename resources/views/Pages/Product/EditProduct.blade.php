            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <form class="form-card"  action="{{ route('updateproduct',[$finddata->id]) }}" method="post" >
                            @csrf
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex">
                                    <label class="form-control-label px-3">Supplier name<span class="text-danger">
                                        ...
                                        placeholder="Enter your name" onblur="validate(1)" value="{{ $finddata->supplier_name }}" required>
                                </div>
                                <div class="form-group col-sm-6 flex-column d-flex"> <label
                                        ...
                                        placeholder="Enter Contact" onblur="validate(2)" value="{{ $finddata->supplier_contact }}" required>
                                </div>
                            </div>
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex"> <label
                                        ...
                                        onblur="validate(3)" value="{{ $finddata->product_name }}" required> </div>
                                <div class="form-group col-sm-6 flex-column d-flex"> <label
                                    ...
                                    onkeyup="mult()" value="{{ $finddata->quantity }}" required>
                                </div>
                            </div>
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex"> <label
                                        ...
                                        onblur="validate(5)" value="{{ $finddata->buying_price }}"  required> </div>
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex"> <label
                                        ...
                                        onblur="validate(5)" value="{{ $finddata->selling_price }}" required> </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="form-group col-sm-6"> <button type="submit" class="btn-block btn-primary">Update Data </button> </div>
                            </div>
                        </form>
                    </div>
                </div>
